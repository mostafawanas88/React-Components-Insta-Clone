...
const LikeSection = props => {
  ...
  const [currentLikes, setCurrentLikes] = useState(numberOfLikes);
  ...
  return (
    <div>
      ...
      >
        <div className='like-section-wrapper' onClick={addLikes}> {/* need to ask Brian */}
      ...
      <p className='like-number'>{currentLikes}</p>
    </div>
  );
};
